...
class Vector4Test {
    ...
    void getVector() {
        ...
        assertEquals(vector2.getVector()[0], vector[0], 10e-8);
        assertEquals(vector2.getVector()[1], vector[1],10e-8);
        assertEquals(vector2.getVector()[2], vector[2], 10e-8);
        assertEquals(vector2.getVector()[3], vector[3], 10e-8);
    }
    ...
    void add() {
        ...
        assertEquals(check.getVector()[3], vector[3], 10e-8);
    ...
    void multiByScalar() {
        ...
        assertEquals(check1.getVector()[2], vector2[2], 10e-8);
        assertEquals(check1.getVector()[3], vector2[3], 10e-8);
    ...
    void normalization() {
        ...
        assertEquals(check.getVector()[3], normalization[3], 0.00001);
